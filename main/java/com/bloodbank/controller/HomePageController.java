...
public class HomePageController {
	...
	PersonService personService;
		...
		@RequestMapping(value="/aboutdonation")
		public ModelAndView aboutdonation(HttpServletResponse response, Model model) throws Exception{
			return new ModelAndView("aboutBloodDonationPage");
		}
